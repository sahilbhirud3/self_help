                            ...
                            children: <Widget>[
                              ...
                              TextFormField(
                                ...
                                decoration: InputDecoration(
                                    ...
                                    hintText: "Installment Amount/हप्ता रक्कम",
                                ...
                                validator: (value) {
                                  if (value == null || value.isEmpty) {
                                    return 'Enter Installment Amount/हप्ता रक्कम प्रविष्ट करा';
                                  }
                                  return null;
                                },
                                controller: amt1,
                                                ...
                                                .then((value) =>
                                                    FirebaseFirestore.instance
                                                        ...
                                                        .doc(
                                                            value.docs.first.id)
                                                        .collection('loan')
                                                        .where('type',isEqualTo: type).get().then((value1) => FirebaseFirestore.instance
                                                        .collection('bachatgat')
                                                        .doc(id)
                                                        .collection('users')
                                                        .doc(
                                                        value.docs.first.id)
                                                        .collection('loan').doc(value1.docs.first.id).collection('installments').doc().set(
                                                        {'amount':amt,
                                                          'date':date
                                                        }).then((value2) =>FirebaseFirestore.instance
                                                        .collection('bachatgat')
                                                        .doc(id)
                                                        .collection('users')
                                                        .doc(
                                                        value.docs.first.id)
                                                        .collection('loan').doc(value1.docs.first.id).update({'remAmount':value1.docs.first.get('remAmount')-amt}) )));
                                            //
